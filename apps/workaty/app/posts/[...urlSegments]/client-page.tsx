  ...
  return (
    <ErrorBoundary>
      <Section>
        ...
        >
          <span
            className={`bg-clip-text text-transparent bg-linear-to-r ${titleColorClasses[theme!.color!]}`}
          >
            {post.title}
          </span>
        </h2>
          ...
          <div className="px-4 w-full">
            ...
            >
              <Image
                ...
                src={post.heroImg}
                alt={post.title}
                className="absolute block mx-auto rounded-lg w-full h-auto blur-2xl brightness-150 contrast-[0.9] saturate-200 opacity-50 mix-blend-multiply"
                aria-hidden="true"
                width={500}
                height={500}
